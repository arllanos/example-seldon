...
if __name__ == "__main__":
    ...
    parser.add_argument("ie_service_name", type=str, help="Name of IE Service.")
    ...
    user_object = user_class(args.ie_service_name)
    ...
    port = 9001 #int(os.environ.get(SERVICE_PORT_ENV_NAME,DEFAULT_PORT))
